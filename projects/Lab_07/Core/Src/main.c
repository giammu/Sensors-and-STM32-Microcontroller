...
/* USER CODE BEGIN PV */
uint8_t LM75_ADDRESS = 0b10010000; //address of the slave, left shifted by 1, zero padded (because the address is 7 bit and not 8) (or you can write: 1001000 <<1)
uint8_t LM75_TEMP_ADDRESS = 0x00; //address of the pointer register that stores the converted temperature
